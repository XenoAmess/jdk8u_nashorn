...
public interface MethodHandleFunctionality {
    ...
    /**
     * Wrapper for {@link MethodHandles#throwException(Class, Class)}
     *
    ...
    /**
     * Wrapper for {@link MethodHandles#catchException(MethodHandle, Class, MethodHandle)}
     *
    ...
    /**
     * Wrapper for {@link MethodHandles#constant(Class, Object)}
     *
    ...
    /**
     * Wrapper for {@link MethodHandles#identity(Class)}
     *
    ...
    /**
     * Wrapper for {@link MethodHandle#asType(MethodType)}
     *
    ...
    /**
     * Wrapper for {@link MethodHandle#asCollector(Class, int)}
     *
    ...
    /**
     * Wrapper for {@link MethodHandle#asSpreader(Class, int)}
     *
     * @param handle      handle to convert
    ...
    /**
     * Wrapper for {@link MethodHandle#bindTo(Object)}
     *
    ...
    /**
     * Wrapper for {@link MethodHandles.Lookup#findGetter(Class, String, Class)}
      *
    ...
    /**
     * Wrapper for {@link MethodHandles.Lookup#findStaticGetter(Class, String, Class)}
      *
     * @param explicitLookup explicit lookup to be used
     * @param clazz          class to look in
     * @param name           name of field
    ...
    /**
     * Wrapper for {@link MethodHandles.Lookup#findSetter(Class, String, Class)}
      *
     * @param explicitLookup explicit lookup to be used
     * @param clazz          class to look in
     * @param name           name of field
    ...
    /**
     * Wrapper for {@link MethodHandles.Lookup#findStaticSetter(Class, String, Class)}
      *
     * @param explicitLookup explicit lookup to be used
     * @param clazz          class to look in
     * @param name           name of field
    ...
    /**
     * Wrapper for {@link MethodHandles.Lookup#unreflect(Method)}
     *
    ...
    /**
     * Wrapper for {@link MethodHandles.Lookup#findStatic(Class, String, MethodType)}
     *
     * @param explicitLookup explicit lookup to be used
     * @param clazz          class to look in
    ...
    /**
     * Wrapper for {@link MethodHandles.Lookup#findVirtual(Class, String, MethodType)}
     *
     * @param explicitLookup explicit lookup to be used
     * @param clazz          class to look in
     * @param name           name of method
    ...
    /**
     * Wrapper for {@link MethodHandles.Lookup#findSpecial(Class, String, MethodType, Class)}
     *
     * @param explicitLookup explicit lookup to be used
     * @param clazz          class to look in
     * @param name           name of method

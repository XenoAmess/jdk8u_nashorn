...
public final class NashornCallSiteDescriptor extends AbstractCallSiteDescriptor {
     ...
     */
    public static NashornCallSiteDescriptor get(final Lookup lookup, final String name,
    ...
    private static NashornCallSiteDescriptor get(final Lookup lookup, final String operator, final String operand, final MethodType methodType, final int flags) {
    ...
    private NashornCallSiteDescriptor(final Lookup lookup, final String operator, final String operand,
            final MethodType methodType, final int flags) {
        this.lookup = lookup;
